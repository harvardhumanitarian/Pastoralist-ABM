...
public class ResourceConstants {
	...
	public final static String GU_SPRING = "spring"; // rain
	...
	public final static String MAN_MADE_WATER_LAYER = "MAN_MADE_WATER";
	public final static String SLOPE_LAYER = "SLOPE";
	public final static String BOUNDARY_CONTAINER = "BOUNDARY_CONTAINER";
