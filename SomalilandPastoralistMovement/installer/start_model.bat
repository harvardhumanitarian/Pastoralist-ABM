@ECHO OFF
TITLE SomalilandPastoralistMovement
...
CD SomalilandPastoralistMovement

REM Start the Model
START javaw -XX:+IgnoreUnrecognizedVMOptions --add-modules=ALL-SYSTEM --add-exports=java.base/jdk.internal.ref=ALL-UNNAMED -cp %CP% repast.simphony.runtime.RepastMain ./SomalilandPastoralistMovement.rs
